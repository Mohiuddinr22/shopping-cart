...
export const DUMMY_PRODUCTS = [
  ...
  },
  {
    ...
    id: 'p7',
    image: tangerineSilk,
    title: 'Tangerine Silk Grace Saree',
    price: 179.99,
    description:
    'Delicately woven borders add a touch of refined artistry, while the smooth texture ensures effortless comfort throughout the day. Whether paired with traditional gold jewelry or modern minimal accessories, the Tangerine Silk Grace brings out your inner glow and charm.'
    },
    {
      id: 'p8',
      image: sunshineRadiance,
      title: 'Sunshine Radiance Yellow Saree',
      price: 279.99,
      description: 
      'Brighten your wardrobe with the Sunshine Radiance Yellow Saree, a symbol of warmth, positivity, and celebration. Woven with fine craftsmanship, this saree blends traditional elegance with modern charm. The vibrant yellow tone enhances every skin tone, making it a perfect choice for festive occasions, haldi ceremonies, or joyful daytime events.'
    },
    {
      id: 'p9',
      image: rustElegance,
      title: 'Rust Elegance Dress',
      price: 249.99,
      description: 
      'Our rust elegance dress is crafted from high-quality fabric with a soft, flowy silhouette, this dress offers both comfort and elegance. Perfect for evening gatherings, festive celebrations, or casual chic outings, it captures attention with its natural depth of color and graceful fall.'
    }
];
